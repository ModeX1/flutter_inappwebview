...
public class InAppWebView: WKWebView, UIScrollViewDelegate, WKUIDelegate,
    ...
    public override func hitTest(_ point: CGPoint, with event: UIEvent?) -> UIView? {
        ...
        // https://github.com/pichillilorenzo/flutter_inappwebview/pull/2538
...
//            }
    ...
    func createAlertDialog(message: String?, responseMessage: String?, confirmButtonTitle: String?, completionHandler: @escaping () -> Void) {
        ...
        guard let presentingViewController = inAppBrowserDelegate != nil ? inAppBrowserDelegate as? InAppBrowserWebViewController : UIApplication.shared.rootViewController else {
            completionHandler()
            return
        }
